...
var core = async (configuration, onsuccess, onfailure) => {
    try {
        ...
        await driver.get('https://careers.peopleclick.com/careerscp/Client_BrookhavenLab/external/search.do?functionName=getSearchCriteria');
        var loop;
                ...
                if (isPresent) {
                    try {
                        ...
                        if (id) {
                            ...
                            job.JOB_APPLY_URL = "https://careers.peopleclick.com/careerscp/Client_BrookhavenLab/external/jobDetails.do?jobPostId=" + apply[0] + "&localeCode=en-us";
                        }
