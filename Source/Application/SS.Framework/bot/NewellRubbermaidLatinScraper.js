...
var core = async (configuration, onsuccess, onfailure) => {
    try {
        ...
        await driver.get('https://nwl.taleo.net/careersection/10140/jobsearch.ftl?lang=en');
                    ...
                    do {
                        ...
                        if (isPresent) {
                            try {
                                ...
                                job.COMPANY_URL = 'https://nwl.taleo.net/careersection/10140/jobsearch.ftl?lang=en';
                                ...
                                var url = "https://nwl.taleo.net/careersection/10140/jobdetail.ftl?lang=en&job=" + job.JDTID_UNIQUE_NUMBER;
                                ...
                                if (isDetailPage) {
                                    ...
                                    job.JOB_APPLY_URL = "https://nwl.taleo.net/careersection/10140/jobapply.ftl?lang=en&job=" + job.JDTID_UNIQUE_NUMBER;
