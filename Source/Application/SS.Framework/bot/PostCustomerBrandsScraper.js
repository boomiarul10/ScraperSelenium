...
var core = async (configuration, onsuccess, onfailure) => {
    try {
        ...
        await driver.get('https://recruiting2.ultipro.com/POS1003POST/JobBoard/02d39268-67a6-4f0a-8347-ce336b4e5893');
        ...
        do {
            ...
            if (isPresent) {
                try {
                    ...
                    var idElement = await driverjobdetails.findElement(By.xpath('//span[contains(@data-bind,"RequisitionNumber")]'));
                    var id = await idElement.getText();
