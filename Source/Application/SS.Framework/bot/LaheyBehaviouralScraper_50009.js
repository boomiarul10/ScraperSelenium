...
var core = async (configuration, onsuccess, onfailure) => {
    try {
        ...
        await driver.get('https://jobs.lahey.org/psp/erecruit/EMPLOYEE/HRMS/c/HRS_HRAM.HRS_CE.GBL?Page=HRS_CE_HM_PRE&Action=A&SiteId=101');
                ...
                if (isPresent) {
                    try {
                        ...
                        while (run != "completed") {
                            ...
                            job.JOB_LOCATION_STATE = (job.JOB_LOCATION_CITY == "Derry") || (job.JOB_LOCATION_CITY == "Dover") || (job.JOB_LOCATION_CITY == "Nashua") || (job.JOB_LOCATION_CITY == "Portsmouth") || (job.JOB_LOCATION_CITY == "Rochester") || (job.JOB_LOCATION_CITY == "Salem") ? "NH" : "MA";

                            var url = "https://jobs.lahey.org/psp/erecruit/EMPLOYEE/HRMS/c/HRS_HRAM.HRS_CE.GBL?Page=HRS_CE_JOB_DTL&Action=A&JobOpeningId=" + job.JDTID_UNIQUE_NUMBER + "&SiteId=101&PostingSeq=1";
