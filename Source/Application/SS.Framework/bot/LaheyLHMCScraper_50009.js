...
var core = async (configuration, onsuccess, onfailure) => {
    try {
        ...
        await driver.get('https://jobs.lahey.org/psp/erecruit/EMPLOYEE/HRMS/c/HRS_HRAM.HRS_CE.GBL?Page=HRS_CE_HM_PRE&Action=A&SiteId=103');
                ...
                if (isPresent) {
                    try {
                        ...
                        while (run != "completed") {
                            ...
                            var url = "https://jobs.lahey.org/psp/erecruit/EMPLOYEE/HRMS/c/HRS_HRAM.HRS_CE.GBL?Page=HRS_CE_JOB_DTL&Action=A&JobOpeningId=" + job.JDTID_UNIQUE_NUMBER + "&SiteId=103&PostingSeq=1";
