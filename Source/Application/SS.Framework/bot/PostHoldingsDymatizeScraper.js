...
var core = async (configuration, onsuccess, onfailure) => {
    try {
        ...
        await driver.get('https://recruiting2.ultipro.com/POS1003POST/JobBoard/106afe8e-13dc-47fe-920c-9b395e3d1a97');

        var jobCount = await driver.findElements(By.xpath('//*[@id="SearchCount"]/div[1]/span'));
        var isCount = await jobCount.length;
        if (isCount) {
