...
var core = async (configuration, onsuccess, onfailure) => {
    try {
        ...
        await driver.get('https://recruiting2.ultipro.com/POS1003POST/JobBoard/5781a8f3-653b-8fd5-3046-fadcf9d30824');
        ...
        var jobCountValue = 50;
        var counter = 1;
        do {            
            if (parseInt(atsCount) > jobCountValue && counter == jobCountValue) {
                jobCountValue = jobCountValue + 50;
                var loadMoreJobElement = await driver.findElements(By.xpath('//*[@id="LoadMoreJobs"]'));
                var isContain = await loadMoreJobElement.length;
                if (isContain) {
                    var search = await driver.findElement(By.xpath('//*[@id="LoadMoreJobs"]'));
                    await search.click();
                }
            }
            ...
            if (isPresent) {
                try {
                    ...
                    if (isDetailPage) {
                        ...
                        var dateElement = await driverjobdetails.findElement(By.xpath('//*[@class="opportunity-sidebar list-unstyled"]//span[@data-automation="job-posted-date"]'));
