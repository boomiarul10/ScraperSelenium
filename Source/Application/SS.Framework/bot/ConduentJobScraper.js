...
var core = async (configuration, onsuccess, onfailure) => {
    try {
        ...
        await driver.get('https://conduent.taleo.net/careersection/conduent_external_portal/jobsearch.ftl?lang=en');
        driver.sleep(5000);
        
        var atsJobCount = await driver.wait(until.elementLocated(By.xpath("//span[@id='currentPageInfo']")), 8000);
        var atscount = await atsJobCount.getText();
        var record = atscount.split("of");
                                var externalportaljobs = parseInt(record[1]);
                                
                                await driver.get('https://conduent.taleo.net/careersection/conduent_france_en/jobsearch.ftl?lang=en&radiusType=K&location=272840492270&searchExpanded=true&radius=1');
        driver.sleep(5000);
        
        var atsJobCount = await driver.wait(until.elementLocated(By.xpath("//span[@id='currentPageInfo']")), 4000);
        var atscount = await atsJobCount.getText();
        var record = atscount.split("of");
                                var francejobs =parseInt(record[1]);
                                
                                await driver.get('https://conduent.taleo.net/careersection/conduent_canada_en/jobsearch.ftl?lang=en&radiusType=K&location=275240492270&searchExpanded=true&radius=1');
        driver.sleep(5000);
        
        var atsJobCount = await driver.wait(until.elementLocated(By.xpath("//span[@id='currentPageInfo']")), 4000);
        var atscount = await atsJobCount.getText();
        var record = atscount.split("of");
                                var canadajobs =parseInt(record[1]);
                                
                                await driver.get('https://conduent.taleo.net/careersection/conduent_uk_en/jobsearch.ftl?lang=en&radiusType=K&location=272540492270&searchExpanded=true&radius=1');
        driver.sleep(5000);
        ...
        var atscount = await atsJobCount.getText();
        var record = atscount.split("of");
                                var ukjobs =parseInt(record[1]);
                                
                                var totaljobs = externalportaljobs + francejobs + canadajobs + ukjobs;
        ...
        do {
            ...
            if (isJobTypePresent) {
                try {
                        ...
                        do {
                            ...
                            if (isPresent) {
                                try {
                                    ...
                                    service.bot.setProgress(botScheduleID, log.logType.activity, "Failed Job France");
                                    jobMaker.failed.add(job.JDTID_UNIQUE_NUMBER, e.message);
                                    counter++;
                                }
                            }
                    ...
                    service.bot.setProgress(botScheduleID, log.logType.activity, "Pagination Issue France");
                    await driver.findElement(By.xpath("//div[@id='JOB_TYPE-content']/div[" + typeCounter + "]/a/label")).click();
                    await driver.sleep(4000);
                    typeCounter++;
                }
        ...
        do {
            ...
            if (isJobTypePresent) {
                try {
                        ...
                        do {
                            ...
                            if (isPresent) {
                                try {
                                    ...
                                    service.bot.setProgress(botScheduleID, log.logType.activity, "Failed Job Canada");
                                    jobMaker.failed.add(job.JDTID_UNIQUE_NUMBER, e.message);
                                    counter++;
                                }
                            }
                    ...
                    service.bot.setProgress(botScheduleID, log.logType.activity, "Pagination Issue Canada");
                    await driver.findElement(By.xpath("//div[@id='JOB_TYPE-content']/div[" + typeCounter + "]/a/label")).click();
                    await driver.sleep(4000);
                    typeCounter++;
                }
        ...
        do {
            ...
            if (isJobTypePresent) {
                try {
                       ...
                       do {
                            ...
                            if (isPresent) {
                                try {
                                    ...
                                    service.bot.setProgress(botScheduleID, log.logType.activity, "Failed Job Netherlands");
                                    jobMaker.failed.add(job.JDTID_UNIQUE_NUMBER, e.message);
                                    counter++;
                                }
                            }
                    ...
                    service.bot.setProgress(botScheduleID, log.logType.activity, "Pagination Issue Netherlands");
                    await driver.findElement(By.xpath("//div[@id='JOB_TYPE-content']/div[" + typeCounter + "]/a/label")).click();
                    await driver.sleep(4000);
                    typeCounter++;
                }
