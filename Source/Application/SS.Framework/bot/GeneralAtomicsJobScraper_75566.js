...
var core = async (configuration, onsuccess, onfailure) => {
    try {
        ...
        await driver.get('https://sjobs.brassring.com/TGWebHost/home.aspx?partnerid=25539&siteid=5313');
                        ...
                        while (run != "completed") {
                           ...
                           // job.JDTID_UNIQUE_NUMBER = await idElement.getText();
                            ...
                            if (urlID) {
                                ...
                                job.JOB_APPLY_URL = "https://sjobs.brassring.com/TGWebHost/jobdetails.aspx?partnerid=25539&siteid=5313&jobid=" + urlID;
                            }
