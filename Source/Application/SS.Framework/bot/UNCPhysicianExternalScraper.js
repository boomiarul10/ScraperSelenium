...
var core = async (configuration, onsuccess, onfailure) => {
    try {
        ...
        await driver.get('https://unchealthcare.taleo.net/careersection/unc+physician+network+external/jobsearch.ftl?lang=en');
                ...
                do {
                    ...
                    if (isPresent) {
                        try {
                            ...
                            var url = "https://unchealthcare.taleo.net/careersection/unc+physician+network+external/jobdetail.ftl?job=" + job.JDTID_UNIQUE_NUMBER;
                            var applyURL = "https://unchealthcare.taleo.net/careersection/unc+physician+network+external/jobapply.ftl?lang=en&job=" + job.JDTID_UNIQUE_NUMBER + "";
