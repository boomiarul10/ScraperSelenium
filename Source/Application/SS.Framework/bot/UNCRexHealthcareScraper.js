...
var core = async (configuration, onsuccess, onfailure) => {
    try {
        ...
        await driver.get('https://rexcss.igreentree.com/CSS_External/CSSPage_Welcome.asp');
        ...
        for (var i = 2; i <= optionArray.length; i++) {
            var categoryListElement = await driver.findElement(By.xpath('//*[@id="W7"]/ul/li[2]/input'));
