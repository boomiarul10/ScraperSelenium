...
var selenium = package.scrape.seleniumWithChromeOptionsWithPath('/mnt/selenium/staging-feed/CITIUatTaleo/');
...
var core = async (configuration, onsuccess, onfailure) => {
    try {
        ...
        await driver.get('https://securefiletransferuat.citigroup.com/');
        ...
        await password.sendKeys('Tmpuser123');
        await login.click();

        var fileClick = await driver.findElement(By.xpath('//*[@id="f_0"]'));
        await fileClick.click();

        var downloadPath = '/mnt/selenium/staging-feed/CITIUatTaleo/Citi_Talentbrew.xml';
