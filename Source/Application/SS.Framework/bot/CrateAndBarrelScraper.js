...
var core = async (configuration, onsuccess, onfailure) => {
    try {
        ...
        await driver.get('https://crateandbarrel.silkroad.com/epostings/index.cfm?version=1&amp;company_id=15635');
            ...
            do {
                ...
                if (isPresent) {
                    try {
                        ...
                        job.JOB_APPLY_URL = "https://crateandbarrel.silkroad.com/epostings/index.cfm?fuseaction=app.jobinfo&jobid=" + job.JDTID_UNIQUE_NUMBER + "&version=1";
