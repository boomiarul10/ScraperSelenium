...
var core = async (configuration, onsuccess, onfailure) => {
    try {
        ...
        await driver.get('https://nwl.taleo.net/careersection/2/jobsearch.ftl?lang=en');
                    ...
                    do {
                        ...
                        if (isPresent) {
                            try {
                                ...
                                var url = "https://nwl.taleo.net/careersection/2/jobdetail.ftl?job=" + job.JDTID_UNIQUE_NUMBER;
                                var applyURL = "https://nwl.taleo.net/careersection/2/jobapply.ftl?lang=en&job=" + job.JDTID_UNIQUE_NUMBER;
                                ...
                                var typeElement = await driverjobdetails.findElements(By.xpath("//*[@id='requisitionDescriptionInterface.ID1662.row1']"));
                                var typeLength = await typeElement.length;
                                if (typeLength) {
                                    var typeElement = await driverjobdetails.findElement(By.xpath("//*[@id='requisitionDescriptionInterface.ID1662.row1']"));
                                ...
                                job.COMPANY_URL = "https://nwl.taleo.net/careersection/2/jobsearch.ftl?lang=en";
                        ...
                        do {
                            ...
                            if (isPresent) {
                                try {
                                    ...
                                    job.JOB_CATEGORY = category;
                                    job.JOB_SALARY = job.OTHER_CATEGORIEs;
